...
void MPU6050_initialize(void) {
    ...
    MPU6050_setFullScaleGyroRange((GyrAndAccSettings>>2)&3);//陀螺仪最大量程 +-1000度每秒
    MPU6050_setFullScaleAccelRange(GyrAndAccSettings&3);	//加速度度最大量程 +-2G
